...
// Adapted from https://raw.githubusercontent.com/punkpeye/mcp-client/refs/heads/main/src/MCPClient.ts
...
export class MCPStdIOChrome extends EventEmitter {
    ...
    async getDefineChatSessionFunctions() {
